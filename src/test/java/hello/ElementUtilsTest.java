...
public class ElementUtilsTest {
	...
	public void thatBestStringContainsMostVowels() {
		String best = ElementUtils.betterElement("Donkey", "Swamp",
				(s1, s2) -> StringUtils.countVowels(s1) > StringUtils.countVowels(s2) ? s1 : s2);
		assertThat(best, equalTo("Donkey"));
	}

	@Test
	public void thatBestCarIsASkoda() {
		Car best = ElementUtils.betterElement(new Car("Skoda", "Superb"), new Car("Ford", "Ka"),
